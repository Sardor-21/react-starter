...
import ContainerAll from "modules/container/ContainerAll";
					...
					{({ items }) => {
						return (
							<div className="folder-items">
								<div className="folder-item folder-item--blue" onClick={() => setActiveFolder({ id: "#" })}>
									Фотобанк
								</div>
								<div className="folder-item" onClick={() => setActiveFolder(null)}>
									Все
								</div>
								{items?.map(folder => (
